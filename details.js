...
async function loadPokemon(id) {
  try {
    ...
    const abilitiesWrapper = document.querySelector(".pokemon-details-wrap .pokemon-details.move");
...
function displayPokemonDetails(pokemon) {
  ...
  const detailsMainElement = document.querySelector(".details-main");
  detailsMainElement.classList.add(name.toLowerCase());
  ...
  const imageElement = document.querySelector(".details-img-wrapper img");
  ...
  document.querySelector(".pokemon-details-wrap .pokemon-details p.body3-fonts.height")
